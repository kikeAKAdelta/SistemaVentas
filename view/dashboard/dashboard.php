                    ...
                    <div class="card car-principal">
                        <div class="container-fluid">
                            <div class="row mt-4">
                                ...
                                <!-- Inventario -->
                                <div class="col-sm-3 mb-3" onclick="redirectView('inventario'); return false;">
                                    <div class="card car-principal-items">
                                        <div class="card-header fw-bold text-center">
                                            Inventario
                                        </div>

                                        <div class="card-body text-center icon-inventario">
                                ...
                                <!-- Proveedores -->
                                <div class="col-sm-3 mb-3" onclick="redirectView('proveedores'); return false;">
                                    <div class="card car-principal-items">
                                        <div class="card-header fw-bold text-center">
                                            Proveedores
                                        </div>

                                        <div class="card-body text-center icon-proveedores">
